...
* Mon May 11 2020 Rex Dieter <rdieter@fedoraproject.org> - 20.04.0-2
- pull in upstream fix (module/dbus name)
...
* Tue Jun 04 2019 Rex Dieter <rdieter@fedoraproject.org> - 19.04.1-2
- (Build)Requires: /usr/bin/dbus-send (#1716686)
...
- 15.04.2
- Provides: ktp-kded-module, cosmetics
