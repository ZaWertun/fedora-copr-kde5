...
Source1: http://download.kde.org/%{stable}/plasma/%(echo %{version} |cut -d. -f1-3)/kde-gtk-config-%{version}.tar.xz.sig
...
%{_kf5_datadir}/kconf_update/remove_window_decorations_from_gtk_css.sh
%{_kf5_datadir}/kcm-gtk-module/preview.ui
...
* Sun Apr 05 2020 Yaroslav Sidlovsky <zawertun@gmail.com> - 5.18.4.1-3
- rebuild
...
- 5.6.2, Obsoletes: kcm-gtk xsettings-kde (f24+)
...
* Mon Dec 21 2015 Daniel Vrátil <dvratil@fedoraproject.org> - 5.5.1-1
- Plasma 5.5.1
