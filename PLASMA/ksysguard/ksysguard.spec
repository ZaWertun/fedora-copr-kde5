...
Source1: http://download.kde.org/%{stable}/%{name}/%{version}/%{name}-%{version}.tar.xz.sig
...
* Wed Jun 23 2021 Yaroslav Sidlovsky <zawertun@gmail.com> - 5.22.0-1
- ksysguard version still is 5.22.0
